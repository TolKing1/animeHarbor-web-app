...
-- Insert 40 anime
INSERT INTO anime (title, description, type, date, director, created, status, studio_id, image_id)
VALUES ('Haikyuu!!',
        ...
        'SERIES', '2014-04-06', 'Susumu Mitsunaka', CURRENT_TIMESTAMP, 'FINISHED', 2, 2),
       ('Attack on Titan: Junior High',
        'A comedic spin-off of "Attack on Titan" where the characters are students attending Titan Junior High School.',
        'SERIES', '2015-10-04', 'Yoshihide Ibata', CURRENT_TIMESTAMP, 'FINISHED', 1, 2),
       ('Sword Art Online',
        ...
        'SERIES', '2012-07-08', 'Tomohiko Itō', CURRENT_TIMESTAMP, 'FINISHED', 3, 2),
       ('Bleach',
        ...
        'SERIES', '2004-10-05', 'Noriyuki Abe', CURRENT_TIMESTAMP, 'FINISHED', 1, 2),
       ('Attack on Titan: No Regrets',
        ...
        'OVA', '2014-12-09', 'Tetsurō Araki', CURRENT_TIMESTAMP, 'FINISHED', 2, 2),
       ('Demon Slayer: Mugen Train',
        ...
        'MOVIE', '2020-10-16', 'Haruo Sotozaki', CURRENT_TIMESTAMP, 'FINISHED', 3, 2),
       ('Fruits Basket',
        ...
        'SERIES', '2001-07-05', 'Akitaro Daichi', CURRENT_TIMESTAMP, 'FINISHED', 1, 2),
       ('The Promised Neverland',
        ...
        'SERIES', '2019-01-11', 'Mamoru Kanbe', CURRENT_TIMESTAMP, 'FINISHED', 2, 2),
       ('Black Clover',
        ...
        'SERIES', '2017-10-03', 'Tatsuya Yoshihara', CURRENT_TIMESTAMP, 'ONGOING', 3, 2),
       ('Mob Psycho 100',
        'A powerful psychic teenager tries to live a normal life while suppressing his overwhelming psychic abilities.',
        'SERIES', '2016-07-12', 'Yuzuru Tachikawa', CURRENT_TIMESTAMP, 'FINISHED', 1, 2),
       ('JoJo''s Bizarre Adventure',
        ...
        'SERIES', '2012-10-05', 'Naokatsu Tsuda', CURRENT_TIMESTAMP, 'ONGOING', 2, 2),
       ('Gurren Lagann',
        ...
        'SERIES', '2007-04-01', 'Hiroyuki Imaishi', CURRENT_TIMESTAMP, 'FINISHED', 3, 2),
       ('Konosuba: God''s Blessing on This Wonderful World!',
        ...
        'SERIES', '2016-01-14', 'Takaomi Kanasaki', CURRENT_TIMESTAMP, 'FINISHED', 1, 2),
       ('Attack on Titan: Lost Girls',
        ...
        'OVA', '2017-12-08', 'Masashi Koizuka', CURRENT_TIMESTAMP, 'FINISHED', 2, 2),
       ('Kimi no Na wa Another Side: Earthbound',
        ...
        'NOVEL', '2017-06-15', 'Makoto Shinkai', CURRENT_TIMESTAMP, 'FINISHED', 3, 2),
       ('Promare',
        ...
        'MOVIE', '2019-05-24', 'Hiroyuki Imaishi', CURRENT_TIMESTAMP, 'FINISHED', 1, 2),
       ('Dr. Stone',
        ...
        'SERIES', '2019-07-05', 'Shinya Iino', CURRENT_TIMESTAMP, 'ONGOING', 2, 2),
       ('One Piece: Stampede',
        ...
        'MOVIE', '2019-08-09', 'Takashi Otsuka', CURRENT_TIMESTAMP, 'FINISHED', 3, 2),
       ('Demon Slayer: Kimetsu no Yaiba - Entertainment District Arc',
        ...
        'SERIES', '2021-12-05', 'Haruo Sotozaki', CURRENT_TIMESTAMP, 'ONGOING', 1, 2),
       ('Black Butler',
        ...
        'SERIES', '2008-10-03', 'Toshiya Shinohara', CURRENT_TIMESTAMP, 'FINISHED', 2, 2),
       ('Attack on Titan: Before the Fall',
        ...
        'MANGA', '2013-07-17', 'Ryoji Fujiwara', CURRENT_TIMESTAMP, 'FINISHED', 3, 2),
       ('The Rising of the Shield Hero',
        ...
        'SERIES', '2019-01-09', 'Takao Abo', CURRENT_TIMESTAMP, 'ONGOING', 1, 2),
       ('Attack on Titan: Harsh Mistress of the City',
        ...
        'LIGHT_NOVEL', '2014-12-09', 'Ryoji Fujiwara', CURRENT_TIMESTAMP, 'FINISHED', 2, 2),
       ('Cells at Work!',
        ...
        'SERIES', '2018-07-08', 'Kenichi Suzuki', CURRENT_TIMESTAMP, 'FINISHED', 3, 2),
       ('Overlord',
        ...
        'SERIES', '2015-07-07', 'Naoyuki Itou', CURRENT_TIMESTAMP, 'FINISHED', 1, 2),
       ('Attack on Titan: Lost Girls',
        ...
        'MANGA', '2015-08-01', 'Ryoji Fujiwara', CURRENT_TIMESTAMP, 'FINISHED', 2, 2),
       ('No Game No Life',
        ...
        'SERIES', '2014-04-09', 'Atsuko Ishizuka', CURRENT_TIMESTAMP, 'FINISHED', 3, 2),
       ('Attack on Titan: Lost Girls',
        ...
        'NOVEL', '2015-12-09', 'Ryoji Fujiwara', CURRENT_TIMESTAMP, 'FINISHED', 1, 2),
       ('Re:Zero − Starting Life in Another World',
        ...
        'SERIES', '2016-04-04', 'Masaharu Watanabe', CURRENT_TIMESTAMP, 'ONGOING', 2, 2),
       ('Attack on Titan: No Regrets',
        ...
        'MANGA', '2013-11-28', 'Hikaru Suruga', CURRENT_TIMESTAMP, 'FINISHED', 3, 2),
       ('The Seven Deadly Sins',
        ...
        'SERIES', '2014-10-05', 'Tensai Okamura', CURRENT_TIMESTAMP, 'FINISHED', 1, 2),
       ('Attack on Titan: Junior High',
        'A manga adaptation of the comedic spin-off where the characters are students attending Titan Junior High School.',
        'MANGA', '2012-04-09', 'Saki Nakagawa', CURRENT_TIMESTAMP, 'FINISHED', 2, 2),
       ('Attack on Titan: Before the Fall',
        ...
        'NOVEL', '2011-12-09', 'Suzuhito Yasuda', CURRENT_TIMESTAMP, 'FINISHED', 3, 2),
       ('Attack on Titan: Lost Girls',
        'A novel adaptation of the spin-off manga focusing on Annie Leonhart and Mikasa Ackerman during the events of "Attack on Titan".',
        'LIGHT_NOVEL', '2014-05-02', 'Hiroshi Seko', CURRENT_TIMESTAMP, 'FINISHED', 1, 2),
       ('Attack on Titan: Before the Fall',
        'A manga adaptation exploring the events leading up to the creation of the Vertical Maneuvering Equipment and the Survey Corps'' battles against Titans.',
        'MANGA', '2011-08-09', 'Suzuhito Yasuda', CURRENT_TIMESTAMP, 'FINISHED', 2, 2),
       ('Attack on Titan: Harsh Mistress of the City',
        ...
        'MANGA', '2015-08-07', 'Ryoji Fujiwara', CURRENT_TIMESTAMP, 'FINISHED', 3, 2),
       ('Attack on Titan: Lost Girls',
        'A manga adaptation of the spin-off novel focusing on Annie Leonhart and Mikasa Ackerman during the events of "Attack on Titan".',
        'MANGA', '2015-09-09', 'Ryoji Fujiwara', CURRENT_TIMESTAMP, 'FINISHED', 1, 2),
       ('Attack on Titan: Before the Fall',
        'A manga adaptation exploring the events leading up to the creation of the Vertical Maneuvering Equipment and the Survey Corps'' battles against Titans.',
        'MANGA', '2011-10-09', 'Suzuhito Yasuda', CURRENT_TIMESTAMP, 'FINISHED', 2, 2),
       ('Attack on Titan: Harsh Mistress of the City',
        'A manga adaptation of the two-part LIGHT_NOVEL following the story of two characters from the "Attack on Titan" series who struggle to survive in a city outside the walls.',
        'MANGA', '2015-09-09', 'Ryoji Fujiwara', CURRENT_TIMESTAMP, 'FINISHED', 3, 2);

-- Insert 10000 sample views
DO
$$
    DECLARE
        v_anime_id INT;
